...
public class ForStatement {
	...
	public static void main(String[] args) {
		 ...
		 * 10000 with an interestRate of 2,3,4,5,6,7, and 8 and print the results to the
		 * console window.
		 */
		for (int i = 2; i < 9; i++) {
			System.out
		...
		/*
		 * How would you modify the for loop above to do the same thing as shown but to

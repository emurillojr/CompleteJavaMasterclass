...
public class Main {
	...
	public static void main(String[] args) {
		/*
		 * Modify the while code in WhileDoWhile.java class. Make it also record the
		 * total number of even numbers it has found and break once 5 are found and at
		 * the end, display the total number of even numbers found
		 */
		int number = 5;
		int finishNumber = 20;
